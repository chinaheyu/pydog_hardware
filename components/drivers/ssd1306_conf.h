...
// flash×Ö¿â
#define FONT_BASE_ADDRESS 0
#define FONT_6x8_ADDRESS 0
#define FONT_7x10_ADDRESS 95 * 8 * 2
#define FONT_11x18_ADDRESS (FONT_7x10_ADDRESS + 95 * 18 * 2)
#define FONT_16x26_ADDRESS (FONT_11x18_ADDRESS + 95 * 26 * 2)
#define FONT_6x8_SIZE (95 * 2 * 8)
#define FONT_7x10_SIZE (95 * 2 * 10)
#define FONT_11x18_SIZE (95 * 2 * 18)
#define FONT_16x26_SIZE (95 * 2 * 26)
